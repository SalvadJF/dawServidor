                ...
                <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <?php echo e(truncar($categoria->nombre)); ?>

                        </th>
                        <td class="px-6 py-4">
                            <a href="<?php echo e(route('categorias.edit', ['categoria' => $categoria])); ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
...
<?php endif; ?>
                        ...
                        <td class="px-6 py-4">
                            <form action="<?php echo e(route('categorias.destroy', ['categoria' => $categoria])); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
        ...
        <form action="<?php echo e(route('categorias.create')); ?>" class="flex justify-center mt-4 mb-4">
            <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'bg-green-500']); ?>Insertar una nueva categoría <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
...
<?php endif; ?>
<?php /**PATH /home/sjimenez/Escritorio/Eservidor/tiendalaravel2324/resources/views/categorias/index.blade.php ENDPATH**/ ?>