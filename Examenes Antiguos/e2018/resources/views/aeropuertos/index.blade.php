<x-app-layout>
    <div class="relative overflow-x-auto w-3/4 mx-auto shadow-md sm:rounded-lg">
                ...
                @foreach ($aeropuertos as $aeropuerto)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <a href="{{ route('aeropuertos.show', ['aeropuerto' => $aeropuerto]) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                {{ $aeropuerto->nombre }}
                            </a>
                        </th>
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
        ...
        <form action="{{ route('aeropuertos.create') }}" class="flex justify-center mt-4 mb-4">
            <x-primary-button class="bg-green-500">Insertar un Aeropuerto</x-primary-button>
        </form>
    </div>
</x-app-layout>
