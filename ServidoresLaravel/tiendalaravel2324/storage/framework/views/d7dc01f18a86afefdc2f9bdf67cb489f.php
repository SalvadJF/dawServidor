        ...
        <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
            ...
            <form action="<?php echo e(route('realizar_compra')); ?>" method="POST" class="mx-auto flex mt-4">
                ...
                <button type="submit" href=""
                    class="mx-auto focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900">Realizar
                    pedido</button>
            </form>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/sjimenez/Escritorio/Eservidor/ServidoresLaravel/tiendalaravel2324/resources/views/comprar.blade.php ENDPATH**/ ?>