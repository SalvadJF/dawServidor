            ...
            <div class="block mt-4">
                <label for="remember_me" class="inline-flex items-center">
                    <input id="remember_me" type="checkbox"
                        ...
                        name="remember">
                    <span
                        class="ms-2 text-sm text-gray-600"><?php echo e(__('Remember me')); ?></span>
                </label>
            </div>
...
<?php endif; ?>
<?php /**PATH /home/sjimenez/Escritorio/Eservidor/tiendalaravel2324/resources/views/auth/login.blade.php ENDPATH**/ ?>