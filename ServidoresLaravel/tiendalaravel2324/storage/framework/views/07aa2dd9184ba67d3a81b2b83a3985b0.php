                ...
                <?php $__currentLoopData = $facturas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $factura): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <a href="<?php echo e(route('facturas.show', ['factura' => $factura])); ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                <?php echo e(fecha($factura->created_at)); ?>

                            </a>
                        </th>
                        <th scope="row" class="text-right px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <?php echo e($factura->user->name); ?>
...
<?php endif; ?>
<?php /**PATH /home/sjimenez/Escritorio/Eservidor/ServidoresLaravel/tiendalaravel2324/resources/views/facturas.blade.php ENDPATH**/ ?>