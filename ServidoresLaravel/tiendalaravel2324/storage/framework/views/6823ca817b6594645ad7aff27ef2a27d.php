            ...
            <tbody>
                <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">
                            <a href="<?php echo e(route('categorias.edit', ['categoria' => $categoria])); ?>">
...
<?php endif; ?>
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">
                            <form method="post" action="<?php echo e(route('categorias.destroy', ['categoria' => $categoria])); ?>">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
    ...
    <div class="flex justify-center">
        <form action="<?php echo e(route('categorias.create')); ?>" method="get">
            <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'bg-green-700 m-4']); ?>Crear caregoría <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
...
<?php endif; ?>
<?php /**PATH /home/sjimenez/Escritorio/Eservidor/ServidoresLaravel/tiendalaravel2324/resources/views/categorias/index.blade.php ENDPATH**/ ?>